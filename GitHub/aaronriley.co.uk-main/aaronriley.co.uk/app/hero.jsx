        ...
        <div className="w-full md:w-1/2 px-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="text-center">
              <a
                href="#contact"
                className="btn bg-cyan-500 text-stone-900 hover:ring-cyan-500 hover:bg-stone-900 hover:text-stone-50 hover:ring transition ease-in-out delay-150 active:bg-cyan-500 focus:outline-none focus:ring focus:ring-cyan-500 flex justify-center"
              >
                Read my blog
            ...
            <div className="text-center">
              <a
                href="#projects"
                className="btn bg-stone-300 text-stone-900 hover:ring-stone-300 hover:bg-stone-900 hover:text-stone-300 flex justify-center"
              >
