      ...
      <div className="flex flex-wrap -mx-4 mt-5">
        <div className="w-full md:w-1/2 px-5">
          ...
          <p className="text-gray-100 text-left text-lg mb-5 max-w-[600px] mt-4 pb-4">
            ...
            healthy lifestyle. I also enjoy reading self-help books, constantly
            seeking new knowledge and personal growth. These passions and
            pursuits drive me to be the best I can be and to continuously learn
            and grow. I also love coffee, so maybe you could...
          </p>

          <a
            href="https://www.buymeacoffee.com/aaronrileydev"
            className="px-4 mt-4 py-2 font-semibold ring ring-cyan-300 text-sm text-gray-100 hover:text-gray-700 transition ease-in-out delay-150 hover:bg-cyan-300 hover:ring active:bg-cyan-500 focus:outline-none focus:ring focus:ring-cyan-500 rounded-md shadow-sM mt-6"
          >
            Buy Me a Coffee
          </a>
        </div>
