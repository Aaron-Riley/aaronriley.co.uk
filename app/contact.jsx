...
export default function Contact() {
  return (
    <div className="container mx-auto px-20 bg-stone-900 pt-20">
      <div className="text-center text-zinc-100 text-3xl font-semibold pb-5">
        Get In Touch
      </div>
      <div className="text-center text-zinc-100 text-xl font-normal mt-4 pb-5">
        If you would like to get in touch with me for anything tech or business
        related you can reach me by my email below.
      </div>
      ...
      <div className="flex justify-center mt-4 pb-5">
        <a
          ...
          className="px-4 py-2 font-semibold ring ring-cyan-300 text-sm text-gray-100 hover:text-gray-700 transition ease-in-out delay-150 hover:bg-cyan-300 hover:ring active:bg-cyan-500 focus:outline-none focus:ring focus:ring-cyan-500 rounded-md shadow-sm"
        >
          Contact Me
        </a>
      </div>
