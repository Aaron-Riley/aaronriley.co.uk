export default function Projects() {
  return (
    <div
      id="projects"
      class="md:container md:mx-auto px-20 bg-neutral-900 md:pt-20 mb-12"
    >
      ...
      <div className="md:flex md:items-center md:justify-between mb-4">
        <div className="md:w-2/3 p-4">
          ...
          <div className="flex flex-wrap -mx-2">
            ...
            <div className="w-full md:w-1/3 px-2 text-cyan-400">Architecture</div>
          </div>
        </div>
      ...
      <div className="md:flex md:items-center md:justify-between mb-4">
        <div className="md:w-2/3 p-4">
          ...
          <div class="flex flex-wrap -mx-2">
            <div class="w-full md:w-1/3 px-2 text-cyan-400">Conveinience</div>
            <div class="w-full md:w-1/3 px-2 text-cyan-400">Efficiency</div>
            <div class="w-full md:w-1/3 px-2 text-cyan-400">Scalability</div>
          </div>
        </div>
        <div className="md:w-1/2">
          <div className="pb-[56.25%] relative">
      ...
      <div className="md:flex md:items-center md:justify-between mb-4">
        <div className="md:w-2/3 p-4">
          ...
          <div className="max-w-[600px] text-gray-100 text-lg mb-4">
            I have completed the AWS Cloud Practitioner Certification and I am
            well on the way to getting my Solutions Architecture Associate. I
            have learned about AWS Cloud and its global infrastructure, and how
            to use AWS services to build secure and reliable cloud applications.
          </div>
          <div className="flex flex-wrap -mx-2">
            <div className="w-full md:w-1/3 px-2 text-cyan-400">Cloud</div>
            <div className="w-full md:w-1/3 px-2 text-cyan-400">Learning</div>
